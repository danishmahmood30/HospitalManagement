...
<div>
			...
			<colgroup>
				...
				<caption><h2>Delete Patient</mark><h2></caption>
...
<div class="center">
	...
	<tr>
		...
		<input type="hidden" name="action" value="hdjjl">
		<td><button type="submit" name="action" value="Confirm Delete">Confirm Delete</button>
		<td><button type="submit" name="button" value="regex_home">Home</button></td>
		<td><button type="submit" name="button" value="delete_another">Delete Another</button></td>
